...
class Query(_SelectFromElements, SupportsCloneAnnotations, HasPrefixes, HasSuffixes, HasHints, Executable):
    ...
    @property
    def statement(self): # -> Any | FromStatement:
    ...
    def with_labels(self): # -> Any | Query:
        ...
    ...
    def set_label_style(self, style): # -> Any | Query:
    ...
    @property
    def lazy_loaded_from(self): # -> None:
    ...
    def values(self, *columns): # -> Iterator[Any]:
    ...
    def value(self, column): # -> Any | None:
    ...
    @property
    def column_descriptions(self): # -> list[dict[str, Any | bool | None]]:
    ...
    def merge_result(self, iterator, load=...): # -> Iterator[Unknown]:
    ...
    def exists(self): # -> Exists | _symbol:
...
class FromStatement(GroupedElement, SelectBase, Executable):
    ...
    def get_children(self, **kw): # -> Generator[Unknown, None, None]:
        ...
