...
class EnvironmentContext(util.ModuleClsProxy):
    ...
    config = ...
    script = ...
    def __init__(self, config, script, **kw) -> None:
    ...
    def get_tag_argument(self): # -> None:
    ...
    def get_x_argument(self, as_dictionary=...): # -> dict[Unknown | Any, Unknown | Any] | list[Any]:
    ...
    def configure(self, connection=..., url=..., dialect_name=..., dialect_opts=..., transactional_ddl=..., transaction_per_migration=..., output_buffer=..., starting_rev=..., tag=..., template_args=..., render_as_batch=..., target_metadata=..., include_name=..., include_object=..., include_schemas=..., process_revision_directives=..., compare_type=..., compare_server_default=..., render_item=..., literal_binds=..., upgrade_token=..., downgrade_token=..., alembic_module_prefix=..., sqlalchemy_module_prefix=..., user_module_prefix=..., on_version_apply=..., **kw): # -> None:
    ...
    def begin_transaction(self): # -> _GeneratorContextManager[None] | _ProxyTransaction:
    ...
    def get_bind(self): # -> MockConnection:
