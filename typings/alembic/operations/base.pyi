...
class Operations(util.ModuleClsProxy):
    ...
    @classmethod
    def register_operation(cls, name, sourcename=...): # -> (op_cls: Unknown) -> Unknown:
    ...
    @classmethod
    def implementation_for(cls, op_cls): # -> (fn: Unknown) -> Unknown:
    ...
    @classmethod
    @contextmanager
    def context(cls, migration_context): # -> Generator[Operations, None, None]:
        ...
    
    @contextmanager
    def batch_alter_table(self, table_name, schema=..., recreate=..., partial_reordering=..., copy_from=..., table_args=..., table_kwargs=..., reflect_args=..., reflect_kwargs=..., naming_convention=...): # -> Generator[BatchOperations, None, None]:
    ...
    def inline_literal(self, value, type_=...): # -> _literal_bindparam:
